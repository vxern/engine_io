...
enum PacketType {
  ...
  /// - The server ensures that a transport is still open and operational by
  /// asking the client to respond with a packet of type [PacketType.pong] on
  /// it.
  ///
  ...
  /// Matches [id] to its corresponding [PacketType].
  ///
